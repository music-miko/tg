...
var (
	...
	// Arc API — used exclusively for YouTube (download job flow + DB cache)
	ArcApiUrl           = getEnv("API_URL", "https://api.arcmusic.fun")
	ArcApiKey           = os.Getenv("API_KEY")
	// Fallen API — used for all other platforms (Spotify, Apple, SoundCloud, Deezer, etc.)
